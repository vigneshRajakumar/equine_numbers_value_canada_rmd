...
output: 
  github_document:
    toc: true
bibliography: hist_horse_pop.bib
...
The modifications to this code were based on the report in this repository:
https://github.com/ttimbers/equine_numbers_value_canada_parameters


## Results

```{r plot horses, fig.width=10, fig.height=4, fig.cap = "Figure 1. Historical horse populations in Canadian provinces", out.width='100%'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap=paste("Figure 2. Horse population for ", params$province," between 1940 - 1967"), out.width='100%'}
